      ...
      <div className="px-4 mt-4">
        <div className="bg-white/10 rounded-xl overflow-hidden">
          <div className="p-4 border-b border-stone-800 flex items-center gap-3">
            <CogIcon className="w-6 h-6 text-stone-400" />
            <span className="text-stone-200">تنظیمات</span>
          </div>
          
          <Link 
            to="/notifications" 
            className="p-4 flex justify-between items-center hover:bg-stone-700/50 transition-colors"
          >
            <div className="flex items-center gap-2">
              <BellIcon className="w-5 h-5 text-stone-400" />
              <span className="text-stone-300">اعلان‌ها</span>
              {hasNewNotifications && (
        ...
        <div className="bg-white/10 rounded-xl overflow-hidden mt-4">
          <div className="p-4 border-b border-stone-800 flex items-center gap-3">
            ...
            <span className="text-stone-200">درباره شیوری</span>
          </div>
